<form action="modules/quanlykhachhang/solve.php" method="post" enctype="multipart/form-data">
  <table border="1" class="table">
    <tbody>
      <tr>
        <td style="border: none" colspan=2 align="center"> Thêm khách hàng</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td style="border: none; text-align: left;margin: 5px;padding: 5px;"><input type="email" name="email" required </td> <tr>
        <td style="border: none" colspan=" 2" align="center"><input type="submit" name="insert" value="Thêm " style="background: white;border:none;color: darkgreen"></td>
      </tr>
      </tr>
    </tbody>
  </table>
