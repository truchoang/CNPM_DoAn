	<?php
   $sql = "select * from thanhvien where ID = $_GET[id] and QuyenHan = 'KH' ";
   $query = mysqli_query($conn, $sql);
   $row = mysqli_fetch_array($query);
		
?>
<form action ="modules/quanlykhachhang/solve.php?id=<?php echo $row['ID'] ?> "method ="post" enctype="multipart/form-data">
...
<table  border="1" class ="table" >
  <tbody >
    ...
    <tr>
      <td colspan = 2 align="center" style="border: none"> <h3>Chỉnh sửa thông tin Khách hàng</h3></td>
    </tr>
    <tr>
    ...
    <tr>
     ...
     <tr >
	 <td style = "border: none; text-align: left;margin: 5px;padding: 5px;"> Chỉnh sữa </td>
	 <td style = "border: none; text-align: left;margin: 5px;padding: 5px;">
	 <input type="date" name = "dateNgayNhap"  value = "<?php echo $row['NgaySinh']?>" ></td></tr>
    </tr>
     <tr >
    ...
    <tr>
	 ...
	 <tr>
	   <td  align="center" style = "border: none; text-align: left;margin: 5px;padding: 5px;" ><input type ="submit" name = "update" value = "Chỉnh sửa" style ="background: white;border:none;color: darkgreen"></td>
	  <td style = "border: none; text-align: left;margin: 5px;padding: 5px;" ><div align="center" ><input type = "submit" name = "cancel" value = "Hủy" style ="background: white;border:none;color: darkgreen"></div></td>
    </tr>
    </tr>
  </tbody>
</table>
